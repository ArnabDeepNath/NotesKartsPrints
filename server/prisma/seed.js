...
async function seed() {
  ...
  const [
    ...
    prisma.genre.create({
      data: { name: "NEET PG", slug: "neet-pg", color: "#e47911" },
    }),
    prisma.genre.create({
      data: {
        name: "Rapid Revision",
    ...
    prisma.genre.create({
      data: { name: "BTR", slug: "btr", color: "#bf5af2" },
    }),
    prisma.genre.create({
      data: {
        name: "Super Speciality",
        slug: "super-speciality",
        color: "#ff6961",
      },
    }),
    prisma.genre.create({
      data: { name: "USMLE", slug: "usmle", color: "#2997ff" },
    }),
    prisma.genre.create({
      data: { name: "BDS Dental", slug: "bds-dental", color: "#ffd60a" },
    }),
    prisma.genre.create({
      data: { name: "MBBS", slug: "mbbs", color: "#34aadc" },
    }),
    prisma.genre.create({
      data: { name: "Thesis & Research", slug: "thesis", color: "#5ac8fa" },
    }),
  ]);
  ...
  const books = [
    // â”€â”€ NEET PG â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    {
      ...
      shortDesc:
        "Exam-ready Medicine notes for NEET PG with mnemonics and PYQ analysis.",
      price: 799,
      comparePrice: 1199,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
      isbn: "BNPG-MED-001",
    ...
    },
    {
      ...
      shortDesc:
        "High-yield Surgery notes with operative details and MCQ tips for NEET PG.",
      price: 749,
      comparePrice: 1099,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
    ...
    },
    {
      ...
      shortDesc:
        "All-in-one Pharmacology notes with drug charts and clinical tips.",
      price: 699,
      comparePrice: 999,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
    ...
    // â”€â”€ Rapid Revision â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    {
      ...
      shortDesc:
        "Quick-review Pathology guide perfect for last-minute NEET PG prep.",
      price: 499,
      comparePrice: 699,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
    ...
    },
    {
      ...
      shortDesc:
        "Fast-track Pharmacology revision guide with drug tables for NEET PG.",
      price: 449,
      comparePrice: 649,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
    ...
    },
    {
      ...
      shortDesc:
        "Comprehensive BTR Anatomy notes with diagrams and memory aids.",
      price: 649,
      comparePrice: 949,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
    ...
    // â”€â”€ USMLE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    {
      ...
      shortDesc:
        "High-yield USMLE Step 1 Pathology notes for IMGs and US medical students.",
      price: 1299,
      comparePrice: 1799,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
    ...
    // â”€â”€ BDS Dental â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    {
      ...
      shortDesc:
        "Complete Oral Medicine notes for BDS final year and MDS entrance.",
      price: 599,
      comparePrice: 899,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
    ...
    },
    {
      ...
      shortDesc:
        "Structured Conservative Dentistry and Endodontics notes for BDS/MDS.",
      price: 549,
      comparePrice: 849,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
    ...
    // â”€â”€ MBBS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    {
      ...
      shortDesc:
        "All-in-one MBBS First Year notes for Anatomy, Physiology, and Biochemistry.",
      price: 1499,
      comparePrice: 2199,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
    ...
    },
    {
      ...
      shortDesc:
        "Clinical skills guide for MBBS students covering history, examination, and OSCEs.",
      price: 399,
      comparePrice: 599,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
    ...
    // â”€â”€ Super Speciality â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    {
      ...
      shortDesc:
        "High-yield DM Cardiology entrance notes covering ECG, heart failure, and interventions.",
      price: 999,
      comparePrice: 1499,
      coverImage:
        "https://images-na.ssl-images-amazon.com/images/I/71qkMm7QPZL.jpg",
