...
export default function NewBookPage() {
  ...
  const handleAddVariation = () => {
    setVariations((prev) => [
      ...
      {
        id: Date.now(),
        attributes: { type: "Format", value: "Paperback" },
        price: "",
        comparePrice: "",
        stock: "10",
        sku: "",
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              />
              <span className="text-[#232f3e] text-sm font-medium">
            ...
            <div className="pt-6 border-t border-gray-200">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-[#232f3e]">
                  Product Variations
                </h3>
                <button
                  type="button"
                  onClick={handleAddVariation}
                  className="bg-gray-100 hover:bg-gray-200 text-[#232f3e] px-4 py-2 rounded text-sm font-medium transition-colors"
                >
                  + Add Variation
                </button>
              </div>
              <p className="text-gray-500 text-sm mb-4">
                Add variations like Hardcover, Signed Edition, etc. to override
                base pricing.
              </p>
                ...
                {variations.map((v, idx) => (
                  ...
                  >
                    <button
                      ...
                      className="absolute top-4 right-4 text-red-500 hover:underline text-xs"
                    >
                      Remove
                    </button>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            if (e.target.files && e.target.files[0])
                              handleVariationImage(idx, e.target.files[0]);
                          }}
