...
export default function CheckoutPage() {
  ...
  const handleApplyCoupon = async () => {
    ...
    try {
      const res = await api.coupons.validate(couponCode, subtotal);
      if (res.valid) {
        setAppliedCoupon({
  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="pt-6 pb-20 px-4 max-w-5xl mx-auto">
        ...
        >
          <h1 className="text-3xl font-bold text-[#232f3e] mb-6 pt-4">
            Checkout
          </h1>
            ...
            {STEPS.map((s, i) => (
              <div key={s.id} className="flex items-center">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`text-sm font-medium hidden sm:block ${step === s.id ? "text-[#232f3e]" : "text-gray-400"}`}
                  >
                    {s.label}
                  </span>
                </div>
          ...
          <div className="grid lg:grid-cols-[1fr_340px] gap-8">
                  ...
                  >
                    <div className="bg-white border border-gray-200 rounded-md overflow-hidden">
                      <div className="p-5 border-b border-gray-100">
                        <h2 className="font-semibold text-[#232f3e]">
                      ...
                      {cart.length === 0 && printCart.length === 0 ? (
                        <div className="p-10 text-center">
                          ...
                          <button
                            ...
                            className="mt-4 text-[#146eb4] hover:underline text-sm"
                          >
                            Browse Books
                          </button>
                        </div>
                          ...
                          {cart.map((item) => (
                            ...
                            >
                              {item.coverImage ? (
                                ...
                                <div className="w-12 h-16 bg-gray-100 rounded shrink-0 flex items-center justify-center text-xl">
                                  📖
                                </div>
                              )}
                              <div className="flex-1 min-w-0">
                                <p className="text-sm font-medium text-[#232f3e] truncate">
                                  {item.title}
                                </p>
                                {item.variationString && (
                                  <p className="text-[10px] text-[#e47911] mt-0.5">
                                    {item.variationString}
                                  </p>
                                )}
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium text-[#232f3e] w-5 text-center">
                                  {item.quantity}
                                </span>
                                <button
                                  onClick={() =>
                          ...
                          {printCart.map((job) => (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">
                                  {job.copies} Copies • {job.colorMode} •{" "}
                                  {job.binding} Binding
                                </p>
                              </div>
                              <div className="text-right">
                ...
                {step === "shipping" && (
                  ...
                  >
                    <div className="bg-white border border-gray-200 rounded-md p-6">
                      <h2 className="font-semibold text-[#232f3e] mb-5">
                        Shipping Details
                      </h2>
            ...
            <div className="lg:sticky lg:top-24 self-start">
              <div className="bg-white border border-gray-200 rounded-md p-5">
                <h3 className="font-semibold text-[#232f3e] mb-4 text-sm">
                  Order Summary
                </h3>
                <div className="space-y-3 mb-4">
                  {cart.slice(0, 3).map((item) => (
                    <div key={item.bookId} className="flex items-center gap-3">
                      ...
                      <p className="text-xs font-semibold text-[#232f3e]">
                        Rs.{" "}
                  ...
                  {printCart
                    .slice(0, Math.max(0, 3 - cart.length))
                    .map((job) => (
                      <div key={job.id} className="flex items-center gap-3">
                        <div className="w-8 h-11 bg-gray-100 rounded shrink-0 flex items-center justify-center">
                          📄
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-medium text-[#232f3e] truncate">
                        ...
                        <p className="text-xs font-semibold text-[#232f3e]">
                          Rs. {Number(job.price).toLocaleString("en-IN")}
                        </p>
                      </div>
                    ))}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 bg-white border border-gray-300 rounded px-3 py-2 text-gray-800 text-sm focus:outline-none focus:border-[#e47911]"
                        />
                        <button
                          onClick={handleApplyCoupon}
                          disabled={isApplyingCoupon || !couponCode.trim()}
                          className="bg-[#232f3e] hover:bg-[#1a2634] disabled:opacity-50 text-white text-sm font-medium px-4 py-2 rounded transition-colors"
                        >
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-green-600">
                            You saved Rs. {appliedCoupon.discount.toLocaleString("en-IN")}
                          </p>
                        </div>
                        <button
