    ...
    <footer className="bg-[#232f3e] text-white">
      ...
      <div className="bg-[#37475a] py-6 px-4 text-center border-b border-[#485769]">
        ...
        <p className="text-sm text-gray-300 mb-3">
          To track your order status, please visit the delivery website and
          enter your tracking number or phone below.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-gray-300 leading-relaxed mb-3">
              {footer.supportText}{" "}
              <strong className="text-white">{footer.supportPhone}</strong>
            </p>
          ...
          <div>
            ...
            <div className="mt-5 p-3 bg-[#37475a] rounded-lg border border-[#485769]">
              ...
              <p className="text-[10px] text-gray-400 leading-relaxed">
                For COD orders, a {settings.pricing.codAdvancePercent}% advance
                is required. This advance is non-refundable. COD orders cannot
                be modified.
              </p>
          ...
          <div>
            ...
            <div className="mt-4 text-xs text-gray-400 space-y-1">
              <p>📞 {footer.alternatePhone}</p>
              <p>🕐 {footer.supportHours}</p>
      ...
      <div className="border-t border-[#37475a] py-4 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-gray-400">
          <p>
            © {year} {footer.brandName}. {footer.copyrightText}
          </p>
