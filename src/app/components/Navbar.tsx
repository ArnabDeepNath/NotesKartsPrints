        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <a
              ...
              className="flex items-center gap-1 hover:text-[#f5a623] transition-colors"
            >
              <svg
                width="11"
                height="11"
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-4">
          ...
          <Link href="/" className="flex-shrink-0">
            <div className="flex items-center gap-2">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #e47911 0%, #f5a623 100%)",
                }}
              >
                <svg
                  width="18"
              ...
              <div>
                <span className="text-[#232f3e] font-black text-xl tracking-tight leading-none block">
                  {header.brandName}
                </span>
                <span className="text-[#e47911] font-semibold text-[10px] uppercase tracking-widest leading-none">
                  {header.brandAccent}
                </span>
              </div>
            </div>
          ...
          <form onSubmit={handleSearch} className="flex-1 hidden md:flex">
            <div className="flex w-full rounded-md overflow-hidden border-2 border-[#e47911]">
              ...
              <button
                type="submit"
                className="bg-[#e47911] hover:bg-[#c45500] px-5 flex items-center justify-center transition-colors"
              >
                <svg
                  width="18"
                  height="18"
                  ...
                  {userMenuOpen && (
                    ...
                    >
                      <div className="p-3 border-b border-gray-100 bg-gray-50">
                        ...
                        {user.role === "ADMIN" && (
                          <span className="inline-block mt-1 px-2 py-0.5 bg-orange-100 text-[#e47911] text-[10px] font-bold rounded-full">
                            Admin
                          </span>
                        )}
                      </div>
        ...
        <div className="md:hidden px-4 pb-3">
          <form
            ...
            className="flex rounded-md overflow-hidden border-2 border-[#e47911]"
          >
            <input
              type="text"
            ...
            <button
              type="submit"
              className="bg-[#e47911] px-4 flex items-center justify-center"
            >
              <svg
                width="16"
                height="16"
          ...
          <div className="flex items-center overflow-x-auto">
            {CATEGORIES.map((cat) => (
              <Link key={cat.label} href={cat.href}>
                <span
                  className={`whitespace-nowrap text-xs font-semibold px-4 py-2.5 inline-block transition-colors hover:bg-[#485769] cursor-pointer ${cat.label === "New Offers" ? "text-[#f5a623]" : "text-white"}`}
                >
                  {cat.label}
                </span>
              </Link>
          ...
          >
            <div className="px-4 py-3 flex flex-col gap-0">
              {CATEGORIES.map((cat) => (
                ...
                >
                  <div
                    className={`py-2.5 border-b border-gray-100 text-sm font-medium ${cat.label === "New Offers" ? "text-[#e47911]" : "text-gray-700"}`}
                  >
                    {cat.label}
                  </div>
                </Link>
              ...
              <div className="pt-3 flex gap-2">
                {user ? (
                  <button
                    onClick={handleLogout}
                    className="w-full border border-red-400 text-red-500 text-sm font-bold py-2.5 rounded"
                  >
                    Sign Out
                  </button>
                ) : (
                  <>
                    <Link
                      ...
                      className="flex-1"
                    >
                      <button className="w-full border-2 border-[#232f3e] text-[#232f3e] text-sm font-bold py-2.5 rounded">
                        Sign In
                      </button>
                    </Link>
                    <Link
                      ...
                      className="flex-1"
                    >
                      <button className="w-full bg-[#e47911] text-white text-sm font-bold py-2.5 rounded">
                        Register
                      </button>
                    </Link>
                  </>
