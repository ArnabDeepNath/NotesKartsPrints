          ...
          {loading ? (
            <div className="space-y-4">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="bg-white rounded-md h-28 animate-pulse border border-gray-200"
                />
              ))}
            </div>
          ) : wishlist.length === 0 ? (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <Link href={`/books/${book.id}`}>
                          <h3 className="text-base font-semibold text-[#232f3e] hover:text-[#e47911] transition-colors line-clamp-1">
                            {book.title}
                          </h3>
                        </Link>
